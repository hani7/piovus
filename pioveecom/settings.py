...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    # 'axes',  # désactivé — non installé sur cPanel
    # Local
    'pioveapp',
]
...
MIDDLEWARE = [
    ...
    # 'axes.middleware.AxesMiddleware',  # désactivé — non installé sur cPanel
]
...
AUTHENTICATION_BACKENDS = [
    # 'axes.backends.AxesStandaloneBackend',  # désactivé — non installé sur cPanel
